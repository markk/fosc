...
DESCRIPTION:: Attaches group indicators.

'textAlign': [lilypond: `parent-alignment-X`]: Specify on which point of the
parent the object is aligned. The value -1 means aligned on parent’s left edge,
0 on center, and 1 right edge, in X direction. Other numerical values may also
be specified - the unit is half the parent’s width. If unset, the value from
self-alignment-X property will be used.
